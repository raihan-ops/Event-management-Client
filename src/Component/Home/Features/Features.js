            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="container px-6 py-10 mx-auto">
                    <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">explore our
                        <br /> awesome <span class="underline decoration-blue-500">Commitment</span>
                    </h1>

                    <p class="mt-4 text-gray-500 xl:mt-6 dark:text-gray-300">
                       We are very Much Serious to fullfill Our Customers Satisfactions
                    </p>
                    ...
                    <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                        <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                            ...
                            <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Hard Working</h1>
                        ...
                        <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                            ...
                            <p class="text-gray-500 dark:text-gray-300">
                            As an event planner, your organisational skills have to be out of this world. At any one time you will be working on several projects, all of which are operating on different leadtimes.
                            </p>
                        ...
                        <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                            ...
                            <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white"> Maintaining Simple & clean designs</h1>

                            <p class="text-gray-500 dark:text-gray-300">
                                The design should ensure that all the different elements of the event will combine perfectly and transmit coherence. There lies the success. And it is essential that companies have a good design when creating an event because it will reflect its identity and will transmit the brand value to all attendees.
                            </p>
