...
const Login = () => {
    ...
    const handleCreateForm = (e) => {
        ...
        signInUser(createData.email,createData.password,location,navigate);
        e.preventDefault();
    ...
    return (
        <div className="w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            ...
            <p className="mt-8 text-xl font-light text-center text-gray-400"> Don't have an account? <Link to="/signup"
                className="font-medium text-xl text-gray-700 dark:text-gray-200 hover:underline">Create One</Link></p>
        </div>
    );
};
