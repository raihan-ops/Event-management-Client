...
const SignUp = () => {
    ...
    const handleCreateForm = (e) => {
        ...
        registerUser(createData.email, createData.password, createData.name,navigate);
        e.preventDefault();
    ...
    return (
        <div className="w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            ...
            <div className="flex items-center justify-between mt-4">
                ...
                <a href="#" className="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">or Create with Social Media</a>
            ...
            <p className="mt-8 text-xl font-light text-center text-gray-400"> Already have an account? <Link to="/login"
                className="font-medium text-xl text-gray-700 dark:text-gray-200 hover:underline">Login</Link></p>
        </div>
    );
};
